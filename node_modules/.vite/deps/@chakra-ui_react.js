...
import {
  ...
  useToast,
  useUpdateEffect
} from "./chunk-55SNYG3E.js";
import "./chunk-ZRYTYW4C.js";
import {
  Icon,
  createIcon
} from "./chunk-LZ2PPWXA.js";
import {
  Spinner
} from "./chunk-XE2QVNYG.js";
import {
  CSSVars,
  ColorModeContext,
  ColorModeProvider,
...
} from "./chunk-3JG3OTMS.js";
import {
  Global,
  keyframes
} from "./chunk-XUA66P67.js";
import {
  _extends,
  init_extends
...
var AvatarGroup = forwardRef(
  function AvatarGroup2(props, ref) {
    ...
    const clones = reversedChildren.map((child, index) => {
      ...
      return (0, import_react19.cloneElement)(child, compact2(childProps));
    });
    const groupStyles = {
      display: "flex",
      alignItems: "center",
...
function useCallbackRef2(initialValue, callback) {
  var ref = (0, import_react36.useState)(function() {
    return {
      value: initialValue,
      callback,
      facade: {
  ...
  return function wrap2(WrappedComponent) {
    ...
    var SideEffect = function(_PureComponent) {
      ...
      _proto.render = function render() {
        return import_react40.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react41.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react41.useCallback)(() => {
    var _a2;
...
function useShortcut(props = {}) {
  ...
  const [keys, setKeys] = (0, import_react43.useState)([]);
  const timeoutRef = (0, import_react43.useRef)();
  const flush = () => {
  ...
  (0, import_react43.useEffect)(() => flush, []);
...
var useSafeLayoutEffect3 = isBrowser ? import_react44.useLayoutEffect : import_react44.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-TFWETJDV.mjs
var import_react45 = __toESM(require_react(), 1);
function useCallbackRef3(fn2, deps = []) {
  const ref = (0, import_react45.useRef)(fn2);
  useSafeLayoutEffect3(() => {
    ref.current = fn2;
  });
  return (0, import_react45.useCallback)((...args) => {
    var _a2;
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react47.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react52.useRef)();
...
function useOutsideClick(props) {
  ...
  const stateRef = (0, import_react53.useRef)({
    isPointerDown: false,
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react55.useRef)(null);
  const handlers2 = {
...
function useOptionalPart(partId) {
  const [id, setId] = (0, import_react56.useState)(null);
  const ref = (0, import_react56.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react57.useCallback)(
    (next) => {
...
function useEventListenerMap() {
  const listeners = (0, import_react59.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react59.useCallback)((el, type, listener, options) => {
  ...
  const remove = (0, import_react59.useCallback)(
...
function useFocusOnShow(target, options = defaultOptions) {
  ...
  const autoFocusRef = (0, import_react61.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react61.useRef)(visible);
  useSafeLayoutEffect3(() => {
...
function useForceUpdate() {
  const unloadingRef = (0, import_react62.useRef)(false);
  const [count, setCount] = (0, import_react62.useState)(0);
  useUnmountEffect(() => {
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react63.useState)(isOpen);
  const [once, setOnce] = (0, import_react63.useState)(false);
...
function useBoolean(initialState = false) {
  const [value, setValue] = (0, import_react64.useState)(initialState);
  const callbacks = (0, import_react64.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react65.useState)(false);
  const [valueState, setValueState] = (0, import_react65.useState)(value);
  (0, import_react65.useEffect)(() => setValueState(value), [value]);
  const { timeout = 1500, ...copyOptions } = typeof optionsOrTimeout === "number" ? { timeout: optionsOrTimeout } : optionsOrTimeout;
  const onCopy = (0, import_react65.useCallback)(() => {
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react67.useState)(null);
  const rafId = (0, import_react67.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react68.cloneElement)(child, theming) : (0, import_react68.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
var List = forwardRef(function List2(props, ref) {
  ...
  return (0, import_jsx_runtime53.jsx)(ListStylesProvider, { value: styles, children: (0, import_jsx_runtime53.jsx)(
    chakra.ul,
    {
      ref,
...
var OrderedList = forwardRef((props, ref) => {
  const { as, ...rest } = props;
  return (0, import_jsx_runtime53.jsx)(List, { ref, as: "ol", styleType: "decimal", marginStart: "1em", ...rest });
});
OrderedList.displayName = "OrderedList";
var UnorderedList = forwardRef(function UnorderedList2(props, ref) {
  const { as, ...rest } = props;
  return (0, import_jsx_runtime53.jsx)(List, { ref, as: "ul", styleType: "initial", marginStart: "1em", ...rest });
});
UnorderedList.displayName = "UnorderedList";
var ListItem = forwardRef(function ListItem2(props, ref) {
  const styles = useListStyles();
  return (0, import_jsx_runtime53.jsx)(chakra.li, { ref, ...props, __css: styles.item });
});
ListItem.displayName = "ListItem";
var ListIcon = forwardRef(function ListIcon2(props, ref) {
  const styles = useListStyles();
  return (0, import_jsx_runtime53.jsx)(Icon, { ref, role: "presentation", ...props, __css: styles.icon });
});
...
var Grid = forwardRef(function Grid2(props, ref) {
  ...
  return (0, import_jsx_runtime54.jsx)(chakra.div, { ref, __css: styles, ...rest });
});
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const childrenToRender = (0, import_react69.useMemo)(
    () => shouldWrapChildren ? import_react69.Children.map(children, (child, index) => (0, import_jsx_runtime57.jsx)(WrapItem, { children: child }, index)) : children,
  ...
  return (0, import_jsx_runtime57.jsx)(
    chakra.div,
    {
      ...
      overflow: "hidden",
      ...rest,
      children: (0, import_jsx_runtime57.jsx)(chakra.ul, { className: "chakra-wrap__list", __css: styles, children: childrenToRender })
    }
  );
});
...
var StackItem = (props) => (0, import_jsx_runtime58.jsx)(
  chakra.div,
  {
...
var Stack = forwardRef((props, ref) => {
  ...
  const clones = (0, import_react70.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      const wrappedChild = (0, import_jsx_runtime59.jsx)(StackItem, { children: child }, key);
      ...
      return (0, import_jsx_runtime59.jsxs)(import_react70.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
var VStack = forwardRef((props, ref) => (0, import_jsx_runtime60.jsx)(Stack, { align: "center", ...props, direction: "column", ref }));
VStack.displayName = "VStack";

// node_modules/@chakra-ui/layout/dist/chunk-HUQHYERK.mjs
var import_jsx_runtime61 = __toESM(require_jsx_runtime(), 1);
var HStack = forwardRef((props, ref) => (0, import_jsx_runtime61.jsx)(Stack, { align: "center", ...props, direction: "row", ref }));
HStack.displayName = "HStack";

// node_modules/@chakra-ui/layout/dist/chunk-MZBQPWGD.mjs
var import_jsx_runtime62 = __toESM(require_jsx_runtime(), 1);
var StackDivider = (props) => (0, import_jsx_runtime62.jsx)(
  chakra.div,
  {
...
var GridItem = forwardRef(function GridItem2(props, ref) {
  ...
  return (0, import_jsx_runtime63.jsx)(chakra.div, { ref, __css: styles, ...rest });
});
...
var Circle = forwardRef(function Circle2(props, ref) {
  ...
  return (0, import_jsx_runtime65.jsx)(Square, { size, ref, borderRadius: "9999px", ...rest });
});
...
function useHighlight(props) {
  ...
  return (0, import_react71.useMemo)(() => highlightWords({ text, query }), [text, query]);
}
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime66.jsx)(import_jsx_runtime66.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime66.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime66.jsx)(import_react71.Fragment, { children: chunk.text }, index);
  }) });
}
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react73.useState)(() => {
...
function Hide(props) {
  ...
  return (0, import_jsx_runtime77.jsx)(Visibility, { breakpoint: query, hide: true, ssr, children });
}
...
function Show(props) {
  const { children, ssr } = props;
  const query = useQuery(props);
  return (0, import_jsx_runtime78.jsx)(Visibility, { breakpoint: query, ssr, children });
}
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys, setKeys] = (0, import_react74.useState)([]);
  const timeoutRef = (0, import_react74.useRef)();
  const flush = () => {
    if (timeoutRef.current) {
      clearTimeout(timeoutRef.current);
      timeoutRef.current = null;
  ...
  (0, import_react74.useEffect)(() => flush, []);
  function onKeyDown(fn2) {
    return (event) => {
      if (event.key === "Backspace") {
        const keysCopy = [...keys];
...
function useEventListeners() {
  const listeners = (0, import_react75.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react75.useCallback)((el, type, listener, options) => {
    listeners.current.set(listener, { type, el, options });
    el.addEventListener(type, listener, options);
  }, []);
  const remove = (0, import_react75.useCallback)(
    (el, type, listener, options) => {
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react76.useState)(true);
  const [isPressed, setIsPressed] = (0, import_react76.useState)(false);
  ...
  const onDocumentKeyUp = (0, import_react76.useCallback)(
    (e) => {
  ...
  const handleKeyUp = (0, import_react76.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react76.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseOver = (0, import_react76.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react76.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function useFocusOnShow2(target, options = defaultOptions2) {
  ...
  const autoFocusValue = shouldFocus && visible;
  const autoFocusRef = (0, import_react77.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react77.useRef)(visible);
  useSafeLayoutEffect(() => {
    if (!lastVisibleRef.current && visible) {
      autoFocusRef.current = autoFocusValue;
    }
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react78.useRef)(null);
  const popper2 = (0, import_react78.useRef)(null);
  const instance = (0, import_react78.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction);
  const cleanup = (0, import_react78.useRef)(() => {
  });
  const setupPopper = (0, import_react78.useCallback)(() => {
    var _a2;
  ...
  const referenceRef = (0, import_react78.useCallback)(
    (node2) => {
  ...
  const getReferenceProps = (0, import_react78.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react78.useCallback)(
    (node2) => {
  ...
  const getPopperProps = (0, import_react78.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react78.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react78.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useDisclosure2(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react79.useState)(props.defaultIsOpen || false);
  const isOpen = isOpenProp !== void 0 ? isOpenProp : isOpenState;
  const isControlled = isOpenProp !== void 0;
  const uid = (0, import_react79.useId)();
  const id = idProp != null ? idProp : `disclosure-${uid}`;
  const onClose = (0, import_react79.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(false);
    }
    handleClose == null ? void 0 : handleClose();
  }, [isControlled, handleClose]);
  const onOpen = (0, import_react79.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
    handleOpen == null ? void 0 : handleOpen();
  }, [isControlled, handleOpen]);
  const onToggle = (0, import_react79.useCallback)(() => {
    if (isOpen) {
      onClose();
    } else {
      onOpen();
...
function useMenu(props = {}) {
  ...
  const focusMenu = (0, import_react82.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a2;
      (_a2 = menuRef.current) == null ? void 0 : _a2.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react82.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react82.useCallback)(() => {
    const id2 = setTimeout(() => {
      const last = descendants.lastEnabled();
      if (last)
  ...
  const onOpenInternal = (0, import_react82.useCallback)(() => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react82.useState)(-1);
  useUpdateEffect(() => {
    if (!isOpen) {
      setFocusedIndex(-1);
    }
  ...
  const openAndFocusMenu = (0, import_react82.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react82.useRef)(/* @__PURE__ */ new Set([]));
  useUnmountEffect2(() => {
    timeoutIds.current.forEach((id2) => clearTimeout(id2));
    timeoutIds.current.clear();
  });
  const openAndFocusFirstItem = (0, import_react82.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react82.useCallback)(() => {
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react82.useCallback)(() => {
    var _a2, _b;
  ...
  const rafId = (0, import_react82.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuList(props = {}, ref = null) {
  ...
  const hasBeenOpened = (0, import_react82.useRef)(false);
  if (isOpen) {
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id = `${menuId}-menuitem-${(0, import_react82.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled2 && !isFocusable2
  });
  const onMouseEnter = (0, import_react82.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react82.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react82.useCallback)(
    (event) => {
  ...
  const onFocus3 = (0, import_react82.useCallback)(
    (event) => {
...
var Menu = (props) => {
  ...
  const context = (0, import_react83.useMemo)(() => ctx, [ctx]);
  const { isOpen, onClose, forceUpdate } = context;
  return (0, import_jsx_runtime79.jsx)(MenuDescendantsProvider, { value: descendants, children: (0, import_jsx_runtime79.jsx)(MenuProvider, { value: context, children: (0, import_jsx_runtime79.jsx)(MenuStylesProvider, { value: styles, children: runIfFn(children, { isOpen, onClose, forceUpdate }) }) }) });
};
...
var StyledMenuItem = forwardRef(
  (props, ref) => {
    ...
    const buttonStyles = (0, import_react84.useMemo)(
      () => ({
        textDecoration: "none",
        color: "inherit",
        userSelect: "none",
    ...
    return (0, import_jsx_runtime81.jsx)(chakra.button, { ref, type: btnType, ...rest, __css: buttonStyles });
  }
);
...
var MenuIcon = (props) => {
  ...
  const child = import_react85.Children.only(children);
  const clone = (0, import_react85.isValidElement)(child) ? (0, import_react85.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
var MenuItem = forwardRef((props, ref) => {
  ...
  const _children = shouldWrap ? (0, import_jsx_runtime83.jsx)("span", { style: { pointerEvents: "none", flex: 1 }, children }) : children;
  return (0, import_jsx_runtime83.jsxs)(
    StyledMenuItem,
    {
      ...
      children: [
        icon && (0, import_jsx_runtime83.jsx)(MenuIcon, { fontSize: "0.8em", marginEnd: iconSpacing, children: icon }),
        _children,
        command && (0, import_jsx_runtime83.jsx)(MenuCommand, { marginStart: commandSpacing, children: command })
      ]
    }
  );
});
...
var MenuGroup = forwardRef((props, ref) => {
  ...
  const styles = useMenuStyles();
  return (0, import_jsx_runtime85.jsxs)("div", { ref, className: "chakra-menu__group", role: "group", children: [
    title && (0, import_jsx_runtime85.jsx)(chakra.p, { className: _className, ...rest, __css: styles.groupTitle, children: title }),
    children
  ] });
});
...
var CheckIcon2 = (props) => (0, import_jsx_runtime89.jsx)("svg", { viewBox: "0 0 14 14", width: "1em", height: "1em", ...props, children: (0, import_jsx_runtime89.jsx)(
  "polygon",
  {
    fill: "currentColor",
  ...
  (props, ref) => {
    ...
    return (0, import_jsx_runtime89.jsxs)(
      StyledMenuItem,
      {
        ...
        children: [
          icon !== null && (0, import_jsx_runtime89.jsx)(
            MenuIcon,
            {
              fontSize: "0.8em",
              marginEnd: iconSpacing,
              opacity: props.isChecked ? 1 : 0,
              children: icon || (0, import_jsx_runtime89.jsx)(CheckIcon2, {})
            }
          ),
          (0, import_jsx_runtime89.jsx)("span", { style: { flex: 1 }, children: optionProps.children })
        ]
      }
    );
  }
...
var ModalTransition = (0, import_react86.forwardRef)(
  (props, ref) => {
    const { preset, motionProps = getMotionProps(preset), ...rest } = props;
    return (0, import_jsx_runtime90.jsx)(MotionSection, { ref, ...motionProps, ...rest });
  }
);
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react87.useState)(0);
...
function useModal(props) {
  ...
  const mouseDownTarget = (0, import_react88.useRef)(null);
  const onMouseDown = (0, import_react88.useCallback)((event) => {
  ...
  const getDialogProps = (0, import_react88.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react88.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react88.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
var Modal = (props) => {
  ...
  return (0, import_jsx_runtime91.jsx)(ModalContextProvider, { value: context, children: (0, import_jsx_runtime91.jsx)(ModalStylesProvider, { value: styles, children: (0, import_jsx_runtime91.jsx)(AnimatePresence, { onExitComplete: onCloseComplete, children: context.isOpen && (0, import_jsx_runtime91.jsx)(Portal, { ...portalProps, children }) }) }) });
};
...
function useSpinner(increment, decrement) {
  ...
  const stop = (0, import_react94.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
var NumberDecrementStepper = forwardRef(function NumberDecrementStepper2(props, ref) {
  ...
  return (0, import_jsx_runtime103.jsx)(StyledStepper, { ...decrement, __css: styles.stepper, children: (_a2 = props.children) != null ? _a2 : (0, import_jsx_runtime103.jsx)(TriangleDownIcon, {}) });
});
...
var NumberIncrementStepper = forwardRef(function NumberIncrementStepper2(props, ref) {
  ...
  const styles = useNumberInputStyles();
  return (0, import_jsx_runtime103.jsx)(StyledStepper, { ...increment, __css: styles.stepper, children: (_a2 = props.children) != null ? _a2 : (0, import_jsx_runtime103.jsx)(TriangleUpIcon, {}) });
});
