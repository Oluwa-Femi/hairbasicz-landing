...
import "/Users/tillie/Downloads/PROJECTS_B/hairbasicz-landing/node_modules/react-dynamic-star/dist/style.css";
var counter = 0;
var useId = (prefix) => {
...
var createStarWithPercentageFilled = (roundedOneDecimalPoint) => ({
...
function DynamicStar({
  ...
  return jsx("div", {
    ...
    children: stars.map((star, index) => jsx("div", {
...
var MemoizedComponent = React.memo(DynamicStar);
export {
  MemoizedComponent as DynamicStar
};
/*
object-assign
(c) Sindre Sorhus
 ...
 */
//# sourceMappingURL=react-dynamic-star.js.map
