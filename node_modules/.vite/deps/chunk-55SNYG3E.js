...
function useVisualElement(Component2, visualState, props, createVisualElement2) {
  ...
  const useAnimateChangesEffect = window.HandoffAppearAnimations ? useIsomorphicLayoutEffect : import_react9.useEffect;
...
function createContext9(options = {}) {
  ...
  function useContext16() {
    ...
    if (!context && strict) {
      ...
      (_a = Error.captureStackTrace) == null ? void 0 : _a.call(Error, error, useContext16);
      throw error;
    }
    return context;
  }
...
function createStandaloneToast({
  ...
  const ToastContainer = () => (0, import_jsx_runtime12.jsx)(ThemeProvider, { theme, children: (0, import_jsx_runtime12.jsx)(ColorModeContext.Provider, { value: colorModeContextValue, children: (0, import_jsx_runtime12.jsx)(
    ToastProvider,
    {
      defaultOptions,
      motionVariants,
...
//# sourceMappingURL=chunk-55SNYG3E.js.map
